"""
Live Clustering — Traffic Mapping Cache (Phase 6)

Bounded, thread-safe cache for external segment -> RouteFlow edge mappings.
Prevents repeating spatial candidate searches on unchanged traffic segments.
"""
import threading
import time
...
class TrafficMappingCache:
    def __init__(self, max_entries: int = MAX_MAPPING_CACHE_ENTRIES):
        ...
        # Key: (external_segment_id, round(lat, 4), round(lon, 4)) -> Value: mapped_dict
